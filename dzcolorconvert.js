/* dzcolor.js ver.1.11 by w3schools.com (Do not remove this line)*/
(function () {
function dzcolor(color, elmnt) {
  if (!(this instanceof dzcolor)) { return new dzcolor(color, elmnt); }
...
function w3SetColorsByAttribute() {
  ...
  for (i = 0; i < z.length; i++) {
    ...
    if (att) {
      z[i].style.backgroundColor = dzcolor(att).toRgbString();      
    }
  }
}